...
function onCreate()
	...
	makeLuaSprite('back2', 'dave/corn', -280, -300);
	makeLuaSprite('back1', 'dave/cornafternoonoverlay', -280, -300);
	setLuaSpriteScrollFactor('back2', 1, 1);         
	setLuaSpriteScrollFactor('back1', 1, 1);         
	addLuaSprite('back2', false);
	addLuaSprite('back1', true);
  	setObjectOrder('back1', 25)
 	setObjectCamera('back1', "other")
end
